...
# ### Thomas Ruedas (t dot ruedas at uni-muenster dot de) - radheat v. 1.0a, 19/07/2017
# #### Version history
...
# ### $^{60}$Fe
# The other major radiogenic heat source during the earliest part of Solar System history was probably $^{60}$Fe ($T_{1/2}\approx 2.62$ Myr), which transmutes by two $\beta^-$ decays via $^{60}$Co ($T_{1/2}\approx 5.2712$ yr) to $^{60}$Ni (NUBASE2016) and is now extinct in planetary bodies. As the half-life of the intermediate step is more than six orders of magnitude shorter than that of $^{60}$Fe, the $T_{1/2}$ of the latter is assumed to apply to the entire chain. However, it is the second decay step that contributes more than 95% of the total heat. - As the isotope is extinct, the power calculation for bulk Fe returns zero by default; this can be changed by assigning a non-zero value to `Xiso`.
